...
<h1 className='m-5 font-semibold'>
  ...
  <p><input className='bg-gray-50 border-0.2 rounded-x w-lg p-1'  type="text" placeholder='Available Unit' /></p>
</h1>
...
<div children="item-center justify-center ">
  <button className='bg-sky-800 rounded-2xl p-2 text-white' type='submit'> Create Resident Profile</button >
</div>
</form>
</motion.div>
    </div>
